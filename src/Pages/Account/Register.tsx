...
function Register() {
   ...
   const [userRegisterMutation] = useSignUpMutation();
    const handleRegisterationSubmit = async () =>  {
        ...
        <div className="col-12 col-md-8 col-lg-8 col-xl-6">
          ...
          <div className="row align-items-center">
            <div className="col mt-4">
              <input type="text" className="form-control" placeholder="Full Name" onChange={(e) => setUserDataState((prevState) => {return {...prevState,fullName:e.target.value}})}/>
            </div>
          </div>
          ...
          <select  className="form-control" onChange={(e) => setUserDataState((prevState) => {return {...prevState,userType:e.target.value}})}>
            ...
            <option value={SD_ROLES.NormalUser}>Normaly</option>
          </select>
            </div>
          </div>
          <div className="row justify-content-start mt-4">
            <div className="col">
              ...
              <button className="btn btn-primary mt-4" onClick={()=> handleRegisterationSubmit()}>Submit</button>
            </div>
          </div>
        </div>
      </div>
